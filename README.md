[![tests](https://github.com/ddev/ddev-sprout/actions/workflows/tests.yml/badge.svg)](https://github.com/ddev/ddev-sprout/actions/workflows/tests.yml) ![project is maintained](https://img.shields.io/maintenance/yes/2024.svg)

# ddev-sprout <!-- omit in toc -->

* [What is ddev-sprout?](#what-is-ddev-sprout)
...
* The fundamental contents of the add-on service or other component. For example, in this template there is a [docker-compose.sprout.yaml](docker-compose.sprout.yaml) file.
...
3. Globally replace "sprout" with the name of your add-on.
4. Add the files that need to be added to a DDEV project to the repository. For example, you might replace `docker-compose.sprout.yaml` with the `docker-compose.*.yaml` for your recipe.
